  ...
  <b-container>
    <b-row class="my-2">
      ...
      <b-col cols="12" lg="6">
        ...
        >
          <template #header>
            <div class="font-weight-bold">Change recipe information</div>
          </template>

          <b-input-group prepend="set date" size="sm" class="my-1">
            <b-form-datepicker
              id="datepicker01"
              :value="recipeDateComputed"
              @input="updateDate"
            ></b-form-datepicker>
          </b-input-group>
